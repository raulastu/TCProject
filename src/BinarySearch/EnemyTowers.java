...
public class EnemyTowers {
    ...
    public int attack(int myUnits, int _hpT, int _attackT, int numWodT, int numStoT) {
        attackT = _attackT;
        hpT = _hpT;
        int lo = 1;
        int hi = myUnits;
    ...
    int nround(int g1, int hpTotal, int remT, int i) {
        ...
        if (i1) {
            System.err.println(g1 + " hpTotal :" + hpTotal + " remT:" + remT + " hpT:" + hpT);
        }
...
// BEGIN CUT HERE
    public static void main(String[] args) {
        try {
            ...
            eq(3, (new EnemyTowers()).attack(1000000000, 40000, 40000, 449, 40000), 7);

//            eq(3, (new EnemyTowers()).attack(1000000000, 40000, 40000, 40000, 40000), 6);
        } catch (Exception exx) {
