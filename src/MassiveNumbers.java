...
public class MassiveNumbers {
    public String getLargest(String numberA, String numberB) {
        String res;
        int a = parseInt(numberA.split("\\^")[0]);
        int powerA = parseInt(numberA.split("\\^")[1]);
        int b = parseInt(numberB.split("\\^")[0]);
        int powerB = parseInt(numberB.split("\\^")[1]);
        if(powerA*log(a)>powerB*log(b)){
        	return numberA;
        }else
        	return numberB;
    }
