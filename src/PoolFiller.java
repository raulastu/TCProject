		...
		for (int i = 0; i < grid.length; i++) {
			for (int j = 0; j < grid[0].length; j++) {
				...
				for (int j2 = 1; j2 < memo.length-1; j2++) {
					Arrays.fill(memo[j2],1,memo[j2].length-2, -1);
				}
//				memo[i][j]=0;
				int cost = go(i, j);
				if (cost > 0) {
	...
	public static void main(String[] args) {
		try {
			eq(0,
					(new PoolFiller()).getCapacity(new String[] { "16661",
							"61116", "16661" }), 15);
			eq(1,
					(new PoolFiller()).getCapacity(new String[] { "999999",
							"955119", "955119", "999999" }), 48);
			eq(2, (new PoolFiller()).getCapacity(new String[] { "111111111",
					"115111611", "131516161", "115111611", "111111111" }), 7);
			eq(3,
					(new PoolFiller()).getCapacity(new String[] {
							"1111111111111", "1555555555551", "1511111111151",
							"1511199911151", "1511192911151", "1511199911151",
							"1511111111151", "1555555555551", "1111111111111" }
